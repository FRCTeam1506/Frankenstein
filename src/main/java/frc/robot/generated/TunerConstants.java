...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(10).withKI(0).withKD(1.75)
    ...
    private static final double kDriveGearRatio = 5.27; //R1 = 7.03, R2 = 6.03, R3 = 5.27.
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.116455078125);
    ...
    public static CommandSwerveDrivetrain createDrivetrain() {
         if (!RobotBase.isReal()) {
            // If we are in simulation, return null or an empty, safe object 
            // instead of running the hardware setup code below.
            System.out.println("TunerConstants: Hardware setup skipped in simulation.");
            return null; 
        }
